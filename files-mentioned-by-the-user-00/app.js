...
function learningGuideForNode(node) {
  ...
  return {
    ...
    sections: [
      { title: "核心理解", items: uniqueGuideItems([...topic.core, ...detail.core]).slice(0, 5) },
      { title: "易错提醒", items: uniqueGuideItems([...topic.traps, ...detail.traps]).slice(0, 4) },
      { title: "做题路径", items: uniqueGuideItems([...detail.method, ...topic.method]).slice(0, 4) }
    ]
  };
}
